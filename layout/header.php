<?php 
 ...
 define('ADMINURL','http://localhost/php/WebServiesProject/admin-panel/' );
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark ">
      <div class="container">
      <a class="navbar-brand" href="#">خدماتي</a>
      ...
      <?php if(isset($_SESSION['AdminName'])): ?>
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL ;?>services-admin/show-services.php" style="margin-left: 20px;">Services</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL ;?>Workers/show-workers.php" style="margin-left: 20px;">Worker</a>
          </li>
